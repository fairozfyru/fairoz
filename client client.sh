...
scp -r -P7072  chenserver@192.168.2.2:~/scripts/open_nis_interface.conf /etc/systemd/system/
scp -P 7072 chenserver@192.168.2.2:~/scripts/rc.local /etc/
sudo ufw disable
scp -r -P 7072 chenserver@192.168.2.2:~/Downloads/xp Documents
scp -r -P 7072 chenserver@192.168.2.2:~/scripts/client.sh .